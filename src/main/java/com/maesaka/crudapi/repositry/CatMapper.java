...
public interface CatMapper {
    ...
    @Insert("INSERT INTO cats(id, name, age, favorite_snack) VALUES(#{id}, #{name}, #{age}, #{favorite_snack})")
    @Options(useGeneratedKeys = true, keyProperty = "id")
    void insertCat(Cat cat);

    @Update("UPDATE cats SET name = #{name}, age = #{age},  favorite_snack = #{favorite_snack} WHERE id = #{id}")
